<template>
  <div class="loginContainer">
    <div class="loginInner">
      ...
      <!--@click="$router.back() 设置的是路由返回的界面，可以直接使用-->
...
<script>
export default {
  // 属性来源有三个方面1.data,2.props,3.computed
  data () {
    return {
      // 当为true时，为短信登陆，false为密码登陆
      isShow: true,
      // 手机号
      phone: '',
      // 倒计时剩余的时间
    ...
    sendCode () {
      ...
      if (this.isRightPhone && this.computeTime === 0) {
        ...
        const intervalId = setInterval(() => {
          this.computeTime--
          // 因为外面使用的是=>函数，所以这里的this没有特定的含义，this使用的是外面的this
